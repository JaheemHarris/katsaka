    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Gestion place</li>
    ...
    <section class="section">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Ajouter une nouvelle place de parking</h5>
                        ...
                        <!-- Multi Columns Form -->
						<form class="row g-3" method="POST" action="<?php echo base_url('admin/place/add') ?>">
