	...
	<section class="section">
		<div class="row justify-content-center">
			<div class="col-lg-10">
				...
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Enregistrement de recolte</h5>

						<!-- Horizontal Form -->
						<form class="col-md-8 col-sm-12" method="POST" action="<?php echo base_url('vokatra/ajouter') ?>">
							<div class="row mb-3">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th scope="col">Taolana</th>
                                <th scope="col">Tongony </th>
                                <th scope="col">Lanjany</th>
                            </tr>
                            </thead>
                            <tbody>
                                <?php foreach($liste_vokatra as $vokatra) { ?>
                                    <tr>
                                        <td>Parcelle <?=$vokatra->id_parcelle ?></td>
                                        <td><?=$vokatra->taolany ?></td>
                                        <td><?=$vokatra->tongony ?></td>
                                        <td><?=$vokatra->lanja ?> Kg</td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
