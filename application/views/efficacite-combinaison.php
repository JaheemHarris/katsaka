    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Efficacite Combinaison</li>
            </ol>
        </nav>
    </div>
    <!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Efficacite Combinaison Zezika</h5>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th scope="col">Combinaison Zezika</th>
                                <th scope="col">Taolany </th>
                                <th scope="col">Lanja</th>
                                <th scope="col">Rapport</th>
                            </tr>
                            </thead>
                            <tbody>
                                <?php foreach($liste_combinaison as $combinaison) { ?>
                                    <tr>
                                        <td><?=$combinaison["id_parcelle"] ?></td>
                                        <td><?=$combinaison["combinaison"] ?></td>
                                        <td><?=$combinaison["tongony"] ?></td>
                                        <td><?=$combinaison["lanja"] ?> Kg</td>
                                        <td><?=$combinaison["rapport"] ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
