            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate method="POST" action="<?php echo base_url('user/account/create') ?>">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="prenom" class="form-control" id="yourUsername" required>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Avez-vous déja un compte? <a href="<?php echo base_url('login/user') ?>">Connectez-vous</a></p>
                    </div>
                  </form>
